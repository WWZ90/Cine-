class PersonMoviedb {
    ...
    factory PersonMoviedb.fromJson(Map<String, dynamic> json) => PersonMoviedb(
        ...
        mediaType: json["media_type"] != null ? mediaTypeValues.map[json["media_type"]]! : null,
        adult: json["adult"],
        popularity: json["popularity"]?.toDouble(),
        gender: json["gender"],
        knownForDepartment: json["known_for_department"] != null ? knownForDepartmentValues.map[json["known_for_department"]]! : null,
