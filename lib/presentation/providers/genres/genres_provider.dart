...
final genresMovieProvider =
    StateNotifierProvider<GenresMoviesNotifier, List<Genre>>((ref) {
      final genresMoviesRepository = ref.watch(genresMoviesRepositoryProvider);
      return GenresMoviesNotifier(
        getGenres: genresMoviesRepository.getGenresMovie,
      );
    });

typedef GetGenresMovieCallback = Future<List<Genre>> Function();

class GenresMoviesNotifier extends StateNotifier<List<Genre>> {
...
final genresTVShowProvider =
    StateNotifierProvider<GenresTVShowNotifier, List<Genre>>((ref) {
      final genresTVShowRepository = ref.watch(genresTVShowRepositoryProvider);
      return GenresTVShowNotifier(
        getGenres: genresTVShowRepository.getGenresTVShow,
      );
    });

typedef GetGenresTVShowCallback = Future<List<Genre>> Function();

class GenresTVShowNotifier extends StateNotifier<List<Genre>> {
